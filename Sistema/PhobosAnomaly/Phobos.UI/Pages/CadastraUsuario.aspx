...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="jumbotron jumbotron-fluid bg-dark">
        <div class="container bg-dark ">
            <br />
            <h1 class="text-light font-weight-light">Cadastro de Usuários</h1>
            <br />
            ...
            <asp:TextBox AutoCompleteType="Disabled" ID="txtDataNascUsuario" CssClass="form-control placeholderDate" MaxLength="10" runat="server" Width="50%" />
            <asp:RequiredFieldValidator ID="RequiredData" runat="server" ErrorMessage="Digite a data de nascimento do usuário" ForeColor="Red" ControlToValidate="txtDataNascUsuario">
            </asp:RequiredFieldValidator>
            <br />
