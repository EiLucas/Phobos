<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditaUsuario.aspx.cs" Inherits="Phobos.UI.Pages.EditarUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="jumbotron jumbotron-fluid bg-dark">
        <div class="container">
            ...
            <asp:TextBox AutoCompleteType="Disabled" ID="txtIdUsuario" runat="server" Width="15%" CssClass="form-control" MaxLength="5">
            </asp:TextBox>
